...
The device will answer a connection request with anoter JSON string sent on the same TCP socket. This response JSON string can contain the following informations:
